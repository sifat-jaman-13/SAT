...
void addperson(FILE *fptr)  //function for inputing the contact from the user
{
    system("cls");
    fflush(stdin);
    fseek(fptr,0,2);  //taking pointer to the end position
    ...
    if(c==1)
    {
        ...
        fflush(stdin);
        fgets(contact.fname, sizeof(contact.fname), stdin);
        contact.fname[strcspn(contact.fname, "\n")] = '\0';
        
        printf("\n2.Last Name:");
        fflush(stdin);
        fgets(contact.lname, sizeof(contact.lname), stdin);
        contact.lname[strcspn(contact.lname, "\n")] = '\0';
        ...
        printf("\n6.Birthdate:");
        fflush(stdin);
        fgets(contact.birthdate, sizeof(contact.birthdate), stdin);
        contact.birthdate[strcspn(contact.birthdate, "\n")] = '\0';
...
void displayall(FILE *fptr)
{
    ...
    while(fread(&contact,sizeof(contact),1,fptr)==1)
    {
        ...
        printf("\n6.Birthdate:%s",contact.birthdate);
        printf("\n7.Address:%s\n",contact.address);
        printf("\n***********************************\n");
